︠1ff7e4cc-6fcc-48e1-9ad5-669a4d0bd1cds︠
...
a = Link("link-4-23.lnk")
b = Link("link-5-1-mirror.lnk")

print "Checking knots 4-23 and mirror 5-1.\n"
...
print b.jones_poly()
print b.linking_number()
print b.alexander_poly()
print b.writhe()
